...
{
     pg_query($dbconn,"update dp01 set pic3='".$new_name."' where id_data='".$_POST['id_prod3']."';");}   
 else if (isset($_POST['submit6']))
{
    pg_query($dbconn,"insert into pictureprob03 (pict,id_nam_pic) values ('".$new_name."','".$_POST['id_prod3']."') ;");
    $qresult=pg_query($dbconn,"select pict from pictureprob03 where id_nam_pic='".$_POST['id_prod3']."';");    
