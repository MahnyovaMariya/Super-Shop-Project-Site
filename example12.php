...
{
     pg_query($dbconn,"update dp01 set pic2='".$new_name."' where id_data='".$_POST['id_prod2']."';");}   
 else if (isset($_POST['submit4']))
{
    pg_query($dbconn,"insert into pictureprob02 (pict,id_nam_pic) values ('".$new_name."','".$_POST['id_prod2']."') ;");
    $qresult=pg_query($dbconn,"select pict from pictureprob02 where id_nam_pic='".$_POST['id_prod2']."';");    
