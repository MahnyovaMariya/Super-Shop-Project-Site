...
if ($_POST['hb']=="registration")
{ if((empty($_POST['fio']))||(empty($_POST['mail']))||(empty($_POST['passw']))||(empty($_POST['passw1'])))
{
echo "Форма была заполнена не полностью!<br>";
echo "<a href=http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/registr.php>Вернуться к заполнению формы</a>";
exit(0);
}
else if ($_POST['passw']<>$_POST['passw1'])
{echo "Неверно был введен повторный пароль!<br>";
echo "<a href=http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/registr.php>Вернуться к заполнению формы</a>";
exit(0); } 
else if ($_POST['passw']==$_POST['passw1'])
{
 $b=db_search();
foreach ($b as $kk=>$vv)
{if ($vv['mail']==$_POST['mail'])
{echo "Такой e-mail уже существует!";
 $z=true;}}
if ($z==false)
{
db_store($_POST['fio'], $_POST['mail'], $_POST['passw'], $_POST['passw1']);
$b1=db_search();
...
if ($_POST['efc']=='enterfromcheckout')
{
$b2=db_search();
foreach ($b2 as $kk2=>$vv2)
{if ($vv2['mail']==$_POST['mail'])
{$_SESSION['tov']=$_POST['mail'];
...
<input type=text name=login readonly style='font-family: SupermolotLight; 
                                            ...
                                            left:47px;
                                            background:transparent;' value=".$_SESSION['tov'].">";
echo "<input type=text name=tov readonly style='font-family: SupermolotLight; 
                                            font-size: 14px;
                                            color: #ed1651;
                                            position:absolute;
                                            border:none;
...
<button type=submit class=d4 style='left: 1065px; border:none; cursor:default;' >
...
$_POST['itogo11']=$_POST['itogo11'];
echo "<textarea style='font-family: Supermolot; 
              font-size: 22px; 
              position:absolute; 
              color:#ffffff;
              top:97px;
              ...
              border:none;
              outline:none;
              overflow:hidden;' name=itogo11 class=itogo11 readonly>".$_POST['itogo11']."</textarea>";
$_POST['itogo22']=$_POST['itogo22'];
echo "<textarea style='font-family: Supermolot; 
                             font-size: 12px; 
                             position:absolute; 
              ...
              outline:none;
              overflow:hidden;
              cursor:pointer;' name=itogo22 readonly>".$_POST['itogo22']."</textarea>";
$_POST['itogo33']=$_POST['itogo33'];
echo "<textarea name=itogo33 class=vspom style='top:155px;
                                         left:1070px;
                                         position:absolute;'>".$_POST['itogo33']."</textarea>";
...
<form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/checkout.php' method=POST>
<input type=text name=tov readonly style='font-family: SupermolotLight; 
                                            font-size: 14px;
                                            color: #ed1651;
                                            position:absolute;
...
echo "<textarea style='font-family: Supermolot; 
              ...
              outline:none;
              overflow:hidden;
              opacity:0;' name=itogo11 class=wakeb readonly>".$_POST['itogo11']."</textarea>";
$_POST['itogo22']=$_POST['itogo22'];
echo "<textarea style='font-family: Supermolot; 
                             font-size: 12px; 
                             position:absolute; 
              ...
              outline:none;
              overflow:hidden;
              opacity:0;' name=itogo22 class=wakeb readonly >".$_POST['itogo22']."</textarea>";
$_POST['itogo33']=$_POST['itogo33'];
echo "<textarea name=itogo33 class=vspom style='top:155px;
                                         left:1070px;
                                         position:absolute;'>".$_POST['itogo33']."</textarea>";
