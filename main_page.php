...
<div style="position:relative;">
	<img  src="main_page_images/home1.jpg" style="position:absolute;">
	<img src="main_page_images/icon4.png" style="padding-top: 351px; 
                             position: absolute;">
	<form action="http://test2/product.php" method=POST>
...
<form action='http://test2/catwakeboard.php' method=POST>
<div id='container3'>
...
<form action='http://test2/cattwowhelled1.php' method=POST>
<div id='container4'>
...
<form action='http://test2/catroller12.php' method=POST>
<div id='container5'>
...
<form action='http://test2/catscooter12.php' method=POST>
<div id='container6'>
...
<form action='http://test2/catsnowboard12.php' method=POST>
<div id='container7'>
...
<form action='http://test2/cattennis12.php' method=POST>
<div id='container8'>
...
<button style="position:absolute; 
            ...
            width:25px;
               outline:none;"
               class="left0"><img src="main_page_images/icon2.png" ></button>
<button  style="position:absolute;
               top:675px;
               left:1229px;
               right:158px; 
               ...
               width:25px;
               outline:none;"                
class="right0"> <img src="main_page_images/icon6.png" ></button>
...
<img src="main_page_images/icon8.jpg" style="top:1387px;
                            left:115px;
                            position:absolute;">
<img src="main_page_images/icon7.jpg" style="top:1387px;
                            left:412px;
                            position:absolute;">
<img src="main_page_images/icon9.jpg" style="top:1387px;
                            left:707px;
                            height:315px;
                            position:absolute;
                            width:580px;">
...
<button style="position:absolute; 
            ...
            width:25px;
               outline:none;"
               class="left1"><img src="main_page_images/icon2.png" ></button>
<button  style="position:absolute;
               top:1754px;
               left:1229px;
               right:158px; 
               ...
               width:25px;
               outline:none;"                
class="right1"> <img src="main_page_images/icon6.png" ></button>
...
<div style="height:311px;
            ...
            left:115px;
            right:115px;">
<img src="main_page_images/icon10.jpg">
