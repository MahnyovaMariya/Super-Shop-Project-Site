...
<font style="font-family: SupermolotThinItalic; 
               font-size: 72px; 
               letter-spacing: 0px;   
               color: #000000;">ДВУХКОЛЕСНЫЕ СКЕЙТЫ</font></div>
...
<font style="font-family: SupermolotLight; 
               font-size: 14px; 
               letter-spacing: 0px;   
               color: #999999;">ПОКАЗАНО 1-<?php
$dbconn=pg_connect('host=localhost dbname=twi2_sql user=postgres password=330117') or die('Could not connect: '.pg_last_error());
$qresult1=pg_query($dbconn,"select nameprod from dp01 where id_cat='2' LIMIT 21 OFFSET 0;");
$b1=pg_fetch_all($qresult1);
echo count($b1);
pg_close($dbconn);?> ИЗ <?php
$dbconn=pg_connect('host=localhost dbname=twi2_sql user=postgres password=330117') or die('Could not connect: '.pg_last_error());
$qresult1=pg_query($dbconn,"select nameprod from dp01 where id_cat='2';");
$b1=pg_fetch_all($qresult1);
echo count($b1);
pg_close($dbconn);?> ТОВАРОВ</font></div>

<div style="height: 2090px;
            width: 1170px;
            top: 300px;
            left:107px;
            right:115px;
...
<font style="color:#333333;
            ...
            font-family: SupermolotLight; 
            font-size: 14px;
            position:absolute;">Страница</font>
</div>
...
<?php 
$dbconn=pg_connect("host=localhost dbname=twi2_sql user=postgres password=330117") or die('Could not connect: '.pg_last_error());
$qresult=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 0;");
...
font-family: SupermolotBoldItalic; 
             ...
             position: absolute;
                            ...
                            overflow: hidden;
                            outline:none;
                            width:500px; z-index:10; background:transparent;' readonly>".$vv['nameprod']."</textarea>
<textarea name=feature  style='font-family: SupermolotLight; 
             font-size: 14px; 
             color:#555555;
             top:190px;
             left:300px;
             ...
             line-height:2;
                            ...
                            outline:none;
                            width:610px;
                             height:210px; background:transparent; z-index:10;' readonly>".$vv['feature']."</textarea>
<input type=text name=cen value='".$vv['price1']." руб.' style='
...
font-family: SupermolotBoldItalic; 
             ...
             position: absolute;
                                                                    ...
                                                                    border:none; width:230px;' readonly>
<input type=image src='./uploads/".$vv['pic1']."' style='top:76px;
                                left:0px;
                               height:300px;
                               width:350px;
                                                       position:absolute; outline:none;' >

<div class=d5 style='top:230px;
                     left:940px;
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 1;");
$b1=pg_fetch_all($qresult1);
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 2;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 3;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 4;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 5;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 6;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 7;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 8;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 9;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 10;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 11;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:1055px; position:absolute; left:580px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
                              font-size: 18px; 
                              letter-spacing: 0px; 
                              top:250px;
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 12;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:1055px; position:absolute; left:870px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
                              font-size: 18px; 
                              letter-spacing: 0px; 
                              top:250px;
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 13;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 14;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 15;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:1385px; position:absolute; left:580px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
                              font-size: 18px; 
                              letter-spacing: 0px; 
                              top:250px;
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 16;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:1385px; position:absolute; left:870px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
                              font-size: 18px; 
                              letter-spacing: 0px; 
                              top:250px;
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 17;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 18;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 19;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='2' LIMIT 1 OFFSET 20;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
