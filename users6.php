...
function Func4()
{
document.getElementById('submit7').click();
}
...
document.getElementById('uploadfile1').remove();
document.getElementById('label2').style.visibility="visible";
document.getElementById('label3').style.visibility="visible";
document.getElementById('uploadfile11').style.visibility="visible";
...
document.getElementById('label9').remove();
document.getElementById('submit6').remove();

document.getElementById('uploadfile3').remove();
document.getElementById('label7').style.visibility="visible";
document.getElementById('label8').style.visibility="visible";
document.getElementById('uploadfile33').style.visibility="visible";
document.getElementById('submit5').style.visibility="visible";
...
document.getElementById('label12').remove();
document.getElementById('submit8').remove();

document.getElementById('uploadfile4').remove();
document.getElementById('label10').style.visibility="visible";
document.getElementById('label11').style.visibility="visible";
document.getElementById('uploadfile44').style.visibility="visible";
document.getElementById('submit7').style.visibility="visible";
}

function Check()
{
if (document.getElementById('label1')&&(document.getElementById('uploadfile1')))
{
alert('Прежде чем приступить к выбору файла в этом окне, проверьте, заполнено ли предыдущее!');
return false;
}
else
{
...
<body style="background-color: #ecf0f1;" onMouseMove="document.getElementById('_txt1').innerHTML=document.getElementById('ifrm1').contentDocument.getElementById('qwe').innerHTML;">
<?php 
if ($_POST['out']=="выйти")
{
 unset($_SESSION['log']);
...
?>
<div style="top:3000px; left:300px; height:100px; width:100px; position:absolute; cursor:default;"></div>
...
<textarea name=nameprod id=nameprod class=d3 style="font-family:ProximaNovaLight; top:45px; left:20px;
                                                    width:325px; height:30px; outline:none; resize:none; cursor:default;"></textarea>
<textarea name=price id=price class=d3 style="font-family:ProximaNovaLight; top:167px; left:390px; position:absolute; width:100px;
                                              height:30px; outline:none; resize:none; cursor:default;"></textarea>
<input type=text  name=val id=val class=d3 style="font-family:ProximaNovaLight; top:167px; left:500px; position:absolute;
                                                 width:29px; height:29px; outline:none; resize:none; cursor:default;">
<select id=dost name=dost style='top:167px; left:550px; position:absolute; width:150px; height:30px;'>
<option value="есть в наличии" style="font-family:ProximaNovaLight;">есть в наличии</option>
...
<textarea name=feature id=feature style="height:92px;
            ...
            border: 1px #dee1e2 solid;
            resize:none;
            font-family:ProximaNovaLight; outline:none; cursor:default;"></textarea>
</div>
...
<input type="radio" id="rb2" name="rb" value="new" 
style="line-height:29px;">
...
<textarea name=var1 id=var1  style="height:27px;
            ...
            top:15px;
            left:18px;
            border:1px #dee1e2 solid; outline:none; resize:none; cursor:default; font-family:ProximaNovaLight;"></textarea>
...
<textarea name=idstrr id=idstrr style='    top:675px;
                                                        left:300px;
                                                            position:absolute;              
                                                            border:none;
                                                            height:20px;
...
<input type=text  name=txt value='<?php $_POST['txt']=$_POST['txt1'];
                                                   echo $_POST['txt'];?> ' style='height:34px;
                         width:241px;
                         top:200px;
                         left:0px;
                         position:absolute;
...
left:0px;
 position:absolute;
opacity:0;' readonly>
<textarea name=_txt1 id=_txt1 style='font-family:ProximaNovaLight ; 
              font-size: 16px;
...
left:0px;
 position:absolute;
opacity:0;' readonly></textarea>
<button type=submit name=submitt style="font-family: SupermolotLight; 
              font-size: 18px; 
              line-height: 35.71px; 
              top: 930px;
              left:740px;
...
<form id=form1 action="http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/example_11.php" method=POST enctype=multipart/form-data target=ifrm1>
...
<div id=div1 align="center" style='height:150px;
                                   ...
                                   cursor:default;'><br><br><br>не загружено
...
<input type=submit name=submit1 id=submit1 value='' style='font-family: SupermolotLight; 
                                                        ...
                                                        left:335px;
                                                            ...
                                                            opacity:0;
                                                            visibility:hidden;'>
<label id=label1 for='uploadfile1' style='font-family:SupermolotLight; 
                                font-size: 16px; 
                                top:595px;
                                left:270px;               
                                position:absolute; 
...
<input  name='uploadfile1'  id=uploadfile1  type=file  style='position:absolute; 
                                              height:30px;
                                              width:300px;
                                              top:595px;
                                              left:240px; 
...
<input type=submit name=submit2 id=submit2 value='' style='font-family: SupermolotLight; 
                                                        ...
                                                        left:500px;
                                                            ...
                                                            background-color:#ffffff;
                                                            opacity:0;' >
<textarea id=idstrr1 name=idstrr1 style='    top:620px;
                                                        left:300px;
                                                            position:absolute;              
                                                            border:none;
                                                            height:20px;
...
<input  name='uploadfile1'  type=file  style='position:absolute; 
                                              ...
                                              top:595px;
                                              left:280px; 
                                        opacity:0;' onChange='";?><script>document.getElementById('submit1').click();</script><?php echo "'>
<label id=label3 for='uploadfile11' style='font-family:SupermolotLight; 
                                font-size: 16px; 
                                top:615px;
                                left:275px;               
                                ...
                                text-decoration:underline;
                                height:30px; 
                                width:100px;' >Удалить</label>
<input  id='uploadfile11'  type=button  style='position:absolute; 
                                              height:20px;
                                              width:70px;
                                              top:615px;
                                              left:285px; 
                                             opacity:0;' onClick='MyFunc();'>
...
<iframe src="http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/example_11.php" name=ifrm1 id=ifrm1 style="height:250px;
                                                                                                        width:250px;
                                                                                                        position:absolute;
                                                                                                        top:100px;
                                                                                                        left:1000px;
...
onLoad="document.getElementById('div1').innerHTML=document.getElementById('ifrm1').contentDocument.getElementById('div2').innerHTML;
        document.getElementById('idstrr').innerHTML=document.getElementById('ifrm1').contentDocument.getElementById('idstr').innerHTML;
        document.getElementById('idstrr1').innerHTML=document.getElementById('ifrm1').contentDocument.getElementById('idstr').innerHTML;
        document.getElementById('idstrr2').innerHTML=document.getElementById('ifrm1').contentDocument.getElementById('idstr').innerHTML;
        document.getElementById('idstrr3').innerHTML=document.getElementById('ifrm1').contentDocument.getElementById('idstr').innerHTML;
        document.getElementById('idstrr4').innerHTML=document.getElementById('ifrm1').contentDocument.getElementById('idstr').innerHTML;
        ">
</iframe>

<form id=form2 action="http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/example_12.php" method=POST enctype=multipart/form-data target=ifrm2>
...
<input type=submit name=submit3 id=submit3 value='' style='font-family: SupermolotLight; 
                                                        ...
                                                        left:500px;
                                                            ...
                                                            opacity:0; 
                                                            visibility:hidden;'>
<label id=label6 for='uploadfile2' style='font-family:SupermolotLight; 
                                font-size: 16px; 
                                top:595px;
                                left:445px;               
                                position:absolute; 
...
<input  name='uploadfile2' id='uploadfile2'  type=file  style='position:absolute; 
                                              height:30px;
                                              width:300px;
                                              top:595px;
                                              left:400px; 
                                              opacity:0;
                                              cursor:pointer;' onClick='return Check();' onChange='MyFunc4();'>
...
<input type=submit name=submit4 id=submit4 value='' style='font-family: SupermolotLight; 
                                                        ...
                                                        left:500px;
                                                            ...
                                                            background-color:#ffffff;
                                                            opacity:0;' >
<textarea id=idstrr2 name=idstrr2 style='    top:620px;
                                                        left:470px;
                                                            position:absolute;              
                                                            border:none;
                                                            height:20px;
...
<input  name='uploadfile2'  type=file  style='position:absolute; 
                                              ...
                                              top:595px;
                                              left:400px; 
                                        opacity:0;' onChange=document.getElementById('submit3').click();>
<label id=label5 for='uploadfile22' style='font-family:SupermolotLight; 
                                font-size: 16px; 
                                top:615px;
                                left:450px;               
...
<iframe src="http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/example_12.php" name=ifrm2 id=ifrm2 style="height:150px;
                                                                                                        width:150px;
                                                                                                        position:absolute;
                                                                                                        top:300px;
                                                                                                        left:1000px;
...
<form id=form3 action="http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/example_13.php" method=POST enctype=multipart/form-data target=ifrm3>
...
<div id=div4 align="center" style='height:150px;
                                   ...
                                   font-size:16px;
                                   color:#9d9d9d;
                                   border: 1px #000000 solid;'><br><br><br>не загружено
<?php /*$dbconn=pg_connect("host=localhost dbname=twi2_sql user=postgres password=330117") or die ('Could not connect: '.pg_last_error());
...
<input type=submit name=submit5 id=submit5 value='' style='font-family: SupermolotLight; 
                                                        ...
                                                        left:670px;
                                                            ...
                                                            opacity:0;
                                                            visibility:hidden;'>
<label id=label9 for='uploadfile3' style='font-family:SupermolotLight; 
                                font-size: 16px; 
                                top:595px;
                                left:620px;               
                                position:absolute; 
...
<input  name='uploadfile3' id='uploadfile3'  type=file  style='position:absolute; 
                                              height:30px;
                                              width:300px;
                                              top:595px;
                                              left:620px; 
                                              opacity:0;
                                              cursor:pointer;' onClick='return Check();' onChange='MyFunc7();'>
...
<input type=submit name=submit6 id=submit6 value='' style='font-family: SupermolotLight; 
                                                        ...
                                                        left:670px;
                                                            ...
                                                            background-color:#ffffff;
                                                            opacity:0;' >
<textarea id=idstrr3 name=idstrr3 style='    top:620px;
                                                        left:640px;
                                                            position:absolute;              
                                                            border:none;
                                                            height:20px;
...
<input  name='uploadfile3'  type=file  style='position:absolute; 
                                              ...
                                              top:595px;
                                              left:620px; 
                                        opacity:0;' onChange=document.getElementById('submit5').click();>
<label id=label8 for='uploadfile33' style='font-family:SupermolotLight; 
                                font-size: 16px; 
                                top:615px;
                                left:625px;               
...
<iframe src="http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/example_13.php" name=ifrm3 id=ifrm3 style="height:150px;
                                                                                                        width:150px;
                                                                                                        position:absolute;
                                                                                                        top:500px;
                                                                                                        left:1000px;
...
<form id=form4 action="http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/example_14.php" method=POST enctype=multipart/form-data target=ifrm4>
...
<input  id='uploadfile44'  type=button  style='position:absolute; 
                                              ...
                                              left:795px; 
                                             opacity:0;
                                             visibility:hidden;' onClick='MyFunc8();'>
...
<input type=submit name=submit7 id=submit7 value='' style='font-family: SupermolotLight; 
                                                        ...
                                                        left:870px;
                                                            ...
                                                            background-color:#ffffff;
                                                            visibility:hidden;'>
<label id=label12 for='uploadfile4' style='font-family:SupermolotLight; 
                                font-size: 16px; 
                                top:595px;
                                left:790px;               
                                position:absolute; 
...
<input  name='uploadfile4' id='uploadfile4'  type=file  style='position:absolute; 
                                              height:30px;
                                              width:300px;
                                              top:595px;
                                              left:790px; 
                                              opacity:0;
                                              cursor:pointer;' onClick='return Check();' onChange='MyFunc9();'>
<input type=submit name=submit8 id=submit8 value='' style='font-family: SupermolotLight; 
                                                        ...
                                                        left:820px;
                                                            ...
                                                            background-color:#ffffff;
                                                            opacity:0;' >
<textarea id=idstrr4 name=idstrr4 style='    top:620px;
                                                        left:810px;
                                                            position:absolute;              
                                                            border:none;
                                                            height:20px;
...
<input  name='uploadfile4'  type=file  style='position:absolute; 
                                              ...
                                              top:595px;
                                              left:790px; 
                                        opacity:0;' onChange=document.getElementById('submit7').click();>
<label id=label11 for='uploadfile44' style='font-family:SupermolotLight; 
                                font-size: 16px; 
                                top:615px;
                                left:795px;               
...
<iframe src="http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/example_14.php" name=ifrm4 id=ifrm4 style="height:150px;
                                                                                                        width:150px;
                                                                                                        position:absolute;
                                                                                                        top:700px;
                                                                                                        left:1000px;
