...
$qresult1=pg_query($dbconn,"select nameprod from dp01 where id_cat='5' LIMIT 18 OFFSET 0;");
...
<form action="http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/catsnowboard123.php" method=POST>
...
$dbconn=pg_connect("host=localhost dbname=twi2_sql user=postgres password=330117") or die('Could not connect: '.pg_last_error());
$num=0;
$qresult=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 0;");
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 1;");
$b1=pg_fetch_all($qresult1);
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 2;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 3;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 4;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 5;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 6;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 7;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 8;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 9;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 10;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 11;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 12;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 13;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 14;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 15;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 16;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
{$num=$num+1;}
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='5' LIMIT 1 OFFSET 17;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{
