...
<font style="font-family: SupermolotThinItalic; 
               font-size: 72px; 
               letter-spacing: 0px;   
               color: #000000;">ТЕННИСНЫЕ РАКЕТЫ</font></div>
...
<font style="font-family: SupermolotLight; 
               font-size: 14px; 
               letter-spacing: 0px;   
               color: #999999;">ПОКАЗАНО 19-<?php
$dbconn=pg_connect('host=localhost dbname=twi2_sql user=postgres password=330117') or die('Could not connect: '.pg_last_error());
$qresult1=pg_query($dbconn,"select nameprod from dp01 where id_cat='6' LIMIT 24 OFFSET 18;");
$b1=pg_fetch_all($qresult1);
echo count($b1)+18;
pg_close($dbconn);?> ИЗ <?php
$dbconn=pg_connect('host=localhost dbname=twi2_sql user=postgres password=330117') or die('Could not connect: '.pg_last_error());
$qresult1=pg_query($dbconn,"select nameprod from dp01 where id_cat='6';");
$b1=pg_fetch_all($qresult1);
echo count($b1);
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 18;");
$b1=pg_fetch_all($qresult1);
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 19;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 20;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 21;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 22;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:400px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
                              font-size: 18px; 
                              letter-spacing: 0px; 
                              top:250px;
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 23;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 24;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 25;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 26;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 27;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 28;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 29;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 30;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 31;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 32;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 33;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 34;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 35;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 36;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 37;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 38;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 39;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 40;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
...
$qresult1=pg_query($dbconn,"select * from dp01 where id_cat='6' LIMIT 1 OFFSET 41;");
$b1=pg_fetch_all($qresult1);
foreach ($b1 as $kk1=>$vv1)
{echo "<div style='width:290px; height:320px; top:395px; position:absolute; left:0px;'><form action='http://shoggoth.ru/edu/04/mmahneva/Diploma/pages/product.php' method=POST>
<input type=text name=idproduct value=".$vv1['id_data']." style= 'font-family: SupermolotLightItalic; 
